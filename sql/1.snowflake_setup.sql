...
GRANT USAGE ON DATABASE OPENFLOW TO ROLE KAFKA_OPENFLOW_ROLE;
GRANT USAGE ON SCHEMA OPENFLOW TO ROLE PUBLIC;
GRANT USAGE ON SCHEMA OPENFLOW TO ROLE KAFKA_OPENFLOW_ROLE;
GRANT READ ON IMAGE REPOSITORY OPENFLOW.OPENFLOW.OPENFLOW TO ROLE PUBLIC;
GRANT READ ON IMAGE REPOSITORY OPENFLOW.OPENFLOW.OPENFLOW TO ROLE KAFKA_OPENFLOW_ROLE;
-- Grant runtime role to Openflow admin
GRANT ROLE KAFKA_OPENFLOW_ROLE TO ROLE OPENFLOW_ADMIN_ROLE;

SET CURRENT_USER = (SELECT CURRENT_USER());   
GRANT ROLE KAFKA_OPENFLOW_ROLE TO USER IDENTIFIER($CURRENT_USER);

CREATE SCHEMA IF NOT EXISTS KAFKA_OPENFLOW_DB.AGENTS;
